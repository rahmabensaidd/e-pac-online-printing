...
@Component({
  selector: 'app-design-your-book2-page',
  standalone: true,
  imports: [ReactiveFormsModule, RouterLink, Editor],
  templateUrl: './design-your-book2-page.html',
  styleUrl: './design-your-book2-page.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DesignYourBook2PageComponent implements OnInit {
